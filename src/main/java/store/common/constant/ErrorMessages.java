...
public enum ErrorMessages {
    ...
    PARSING_INTEGER_ERROR("정수 문자열 변환 파싱 에러 입니다.", Type.GENERAL),
    LIST_LENGTH_ERROR("잘못된 데이터가 입력되었습니다. 필드 개수 오류입니다.", Type.GENERAL),
    NULL_OR_EMPTY_ERROR("잘못된 데이터가 입력되었습니다. 비어있는 값입니다.", Type.GENERAL),
    ...
    RESOURCE_FAILED_READ("저장소를 읽을 수 없습니다:", Type.RESOURCE),
